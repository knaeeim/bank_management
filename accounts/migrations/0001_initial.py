...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(choices=[('saving', 'saving'), ('current', 'current'), ('business', 'business'), ('corporate', 'corporate'), ('student', 'student'), ('retirement', 'retirement'), ('other', 'other')], max_length=10)),
